...
class StructureWithForeignKeysTest extends AbstractDatabaseTest
{
    public function testGetTablesStructure(): void
    {
        ...
        $this->assertStringEndsWith('table_1', $table1->getName());
        ...
        $this->assertStringEndsWith('table_2', $table2->getName());
        ...
        $this->assertStringEndsWith('table_3', $table3->getName());
        ...
        foreach ($foreignKeys as $foreignKey) {
            ...
            if (in_array('fk_t1_id', $foreignKeyColumns)) {
                $this->assertStringEndsWith('table_1', $foreignKey->getReferencedTable());
                ...
                $this->assertStringEndsWith('table_2', $foreignKey->getReferencedTable());
                $this->assertEquals(['id'], $foreignKey->getReferencedColumns());
                $this->assertNull($foreignKey->getReferencedDatabase());
            } else {
